...
import profilePic from "@/public/author.webp";
  ...
  return (
    <article className="h-[890px] flex flex-col">
      <div className="grow basis-auto">
        ...
        <p>本站点使用了以下资源：</p>
        <ul>
          <li><a href="https://nextjs.or">Next.js 14</a></li>
        ...
        <p>此外本站所有数据都是通过百度贴吧的API获取的，不会保存任何用户数据。
          编写这个项目时的API参考了<Link
            isExternal
            isBlock
            showAnchorIcon
      ...
      {/* <div className="pt-12 border-t dark:border-gray-300 basis-1/4">
        <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
          <Image src={ profilePic } alt="profilePic" width={96} height={96}
