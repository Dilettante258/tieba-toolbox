...
export default async function UserPostContentPage(props: {
  params: Promise<RequestProps1>;
}) {
  const params = await props.params;

  const { method, id, page } = params;
  ...
  return (
    <div className="main-container justify-start">
      ...
      <p className="page-info">
        当前正在查询用户<span>{id}</span>的回复贴，当前是第<span>{page}</span>页
      </p>
