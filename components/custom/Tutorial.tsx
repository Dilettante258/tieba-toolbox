...
function Tutorial() {
  return (
    <div className={styles.tutorial}>
      <p className={styles.tutorialDescription}><ChevronDown />一个百度账号有多种身份标识，本工具箱支持三种标识：</p>
      <ol className={styles.tutorialList}>
        <li className={styles.tutorialListItem}>
          <h3>1.UID</h3>
        ...
        <li className={styles.tutorialListItem}>
          <h3>2. ID</h3>
          <span>
            <pre><code className={styles.languageJson}>
